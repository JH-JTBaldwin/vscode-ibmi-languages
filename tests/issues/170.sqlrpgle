...
26001  // 07/07/26 Dev2 #5555.55 - Update
...
22001D  JOB_NUMc             264    269                                         Job number   
...
M01         select A.FIELD1, A.FIELD2
             ...
             join YOURFILE B
                  ON A.KEY1     = B.KEY1  AND
                     A.KEY2     = B.KEY2
26001       where A.KEY1 = :MasterKey
26001         and A.KEY2 not in ('MONDAY', 'FRIDAY')
M01           and A.STATUS <> 'I'
26001       order by MONTH(A.KEY1), A.KEY2;
